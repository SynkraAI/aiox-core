...
- API key configurada em `skills/deepgram-transcriber/.env` ou `skills/groq-transcriber/.env`
...
Key em `skills/deepgram-transcriber/.env` ou `skills/groq-transcriber/.env` (gitignored):
...
2. `skills/groq-transcriber/.env` (compartilhado)
