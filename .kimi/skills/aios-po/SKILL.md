...
| `*validate-story-draft` | Validate story quality and completeness (START of story lifecycle) | full, quick, key |
| `*close-story` | Close completed story, update epic/backlog, suggest next (END of story lifecycle) | full, quick, key |
...
| `*shard-doc` | Break document into smaller parts | full |
