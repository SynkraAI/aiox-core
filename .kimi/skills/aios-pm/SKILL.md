...
| `*execute-epic` | Execute epic plan with wave-based parallel development | full, quick, key |
...
| `*toggle-profile` | Toggle user profile between bob (assisted) and advanced modes | full, quick |
