...
- AIOS 2.1+ Framework
- `aios-transcriber` tool dependencies installed (for YouTube content):
  ```bash
  pip3 install yt-dlp
  ```
...
2. **Collect** - Downloads content using WebFetch + aios-transcriber
...
| YouTube videos | WebSearch | aios-transcriber | `sources/youtube/{slug}/` |
...
| **aios-transcriber** (CLI tool) | Download and transcribe YouTube videos | Collection |
| **youtube-captions** (CLI tool) | Search and discover YouTube videos | Discovery |
