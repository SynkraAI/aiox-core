...
agent:
  ...
  customization: |
    ...
    - PATH VALIDATOR: Ensure clones exist in squads/mind-cloning/minds/ before execution
...
security:
  code_generation:
    ...
    - "SANITIZE PATHS: Validate clone names against squads/mind-cloning/minds/ directory"
    - "WHITELIST ONLY: Only allow access to squads/mind-cloning/minds/ and outputs/debates/"
...
dependencies:
  ...
  data:
    - squads/mind-cloning/minds/<mind-name>/system_prompts/ (clone system prompts)
    - squads/mind-cloning/minds/<mind-name>/kb/ (clone knowledge bases)
