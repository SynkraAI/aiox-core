...
- **YouTube Captions** (`tools/youtube-captions/`) — Auto-discover and extract transcripts from an expert's top YouTube videos. Use `--search "{name}"` to find and download up to 100 transcripts in one command. See `tools/youtube-captions/README.md`.
